  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Learner outcomes on <b style={{ color: "#0056d2" }}>NM</b>
        </Text>
        <Text
          fontFamily={"poppins"}
          fontSize={{
